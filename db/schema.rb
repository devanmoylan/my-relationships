...
ActiveRecord::Schema.define(version: 20_200_228_210_414) do
  ...
  create_table 'mentions', force: :cascade do |t|
    ...
    t.index %w[mentionable_type mentionable_id], name: 'index_mentions_on_mentionable_type_and_mentionable_id'
    t.index %w[sourceable_type sourceable_id], name: 'index_mentions_on_sourceable_type_and_sourceable_id'
  end
  ...
  create_table 'personal_profiles', id: false, force: :cascade do |t|
    t.bigint 'user_id', null: false
    t.bigint 'person_id', null: false
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['person_id'], name: 'index_personal_profiles_on_person_id'
  ...
  create_table 'reminders', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[memorable_type memorable_id], name: 'index_reminders_on_memorable_type_and_memorable_id'
  end
  ...
  add_foreign_key 'personal_profiles', 'people'
