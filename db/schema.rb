...
ActiveRecord::Schema.define(version: 20_200_114_220_304) do
  ...
  create_table 'connections', force: :cascade do |t|
    ...
    t.index %w[person_one_id person_two_id], name: 'index_connections_on_person_one_id_and_person_two_id'
  end
